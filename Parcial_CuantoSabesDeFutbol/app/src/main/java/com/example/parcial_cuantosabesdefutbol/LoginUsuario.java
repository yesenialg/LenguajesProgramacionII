...
public class LoginUsuario extends AppCompatActivity {
    ...
    private void noExiste() {
        ...
        for (int i = 0; i < lista.size(); i++){
            if(lista.get(i).getTipo().trim().equals("apostador") && tvUsuario.getText().toString().equals(lista.get(i).getUsuario().trim())){
                existe = true;
    ...
    private void existe() {
        ...
        for (int i = 0; i < lista.size(); i++){
            ...
            if(lista.get(i).tipo.equals("apostador") &&
